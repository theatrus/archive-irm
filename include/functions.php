...
function showSoftware($ID) 
{
	...
	PRINT '<table class="software">
		<form method=post action="'.Config::AbsLoc('users/software-update.php').'">
		<input type=hidden name=ID value="'.$ID.'">
		<input type=hidden name=class value="'.$class.'">
	
	<tr class="computerheader">
		<td colspan=2>'.$class.': '.$name.' ('.$ID.')</td>
		</tr>
	
		<tr class="computerdetail">
		<td>'._("Name:").'
		<br /><input type=text name=name value="'.$name.'" size=24>
		<br />'._("Location:").'
		<br /><input type=text name=package value="'.$package.'" size=20>
		</td>
		<td>'._("Platform:").'<br />
	';
	...
	<td>
		<form method=post action="'.Config::AbsLoc('users/software-del.php').'">
			<input type=submit value="'._("Delete").'" valign=top>
			<input type=hidden name=ID value="'.$ID.'">
		</form>
	</td>
	</tr>
