...
################################################################################
#  portlistoct3.php
#    List the IP addresses of all systems (computers and network devices) 
#    For network devices, just IP of Port 0 (logical_number =0) is shown.
#    The system's (computer, network device, peripheral)
#    name, ID, IP and MAC addresses and comment field will be shown.
#
#  Author:
#  Bruce Luhrs
#  Andy McBride
...
#                               CHANGELOG                                       #
#################################################################################
#  21-Mar-2006  BL  Migrate from IRM 1.5.7 to  IRM v1.5.8                       #
#################################################################################
...
AuthCheck("normal");
commonHeader(_("IP Address Group") . " - " . _("Report"));
$DB = Config::Database();
...
PRINT "This report lists the IP addresses of all computers and network devices.\n";
PRINT "<BR>&nbsp;&nbsp;&nbsp;Only Port 0's IP address is shown for network devices.\n";
PRINT "<BR>&nbsp;&nbsp;&nbsp;Ports without assigned IP Addresses are not being shown.\n";
...
<?php PRINT Config::AbsLoc('users/reports/portlistoct3.php');
?>">
...
<?php
PRINT "<BR>&nbsp;&nbsp;&nbsp;(<I>This report will take about 15 seconds to generate each time. </I>)\n";
PRINT "<P>\n";
