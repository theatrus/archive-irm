...
__("Use this utility to add computers to groups, or to remove computers from groups.");
PRINT "<br><hr noshade>";
...
PRINT "<input type=submit value=Add></form><br>";
__("NOTE: Sometimes this may take a while, depending on the number of computers you have (upwards of 10 seconds).");
